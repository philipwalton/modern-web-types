// Emits the "replace" flavor of the package: each environment's complete
// one-engine lib (build/<env>.full) shipped as a drop-in replacement for the
// corresponding built-in — lib.dom / lib.webworker — or, for the standalone
// worker variants, for the matching @types/* package. A consumer drops the
