...
// AudioWorklet lib that also includes APIs shipped in a single engine.
// Set "lib" without "AudioWorklet" and reference this file instead.
...
interface AudioWorkletGlobalScope extends WorkletGlobalScope {
     ...
     *
     * [MDN Reference](https://developer.mozilla.org/docs/Web/API/AudioWorkletGlobalScope/port)
     */
